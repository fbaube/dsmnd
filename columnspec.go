...
// representation using the enumeration [BasicDatatype].
...
//   - [BasicDatatype] (i.e. storage type): e.g. [db.TEXT], [db.INTG], 
//     [db.PKEY], [db.FKEY]. TODO: Refine by replacing with semantic 
//     (i.e. [SemanticFieldTyp], [SemanticColxnType])
...
func (p *ColumnSpec) String() string {
	...
	return fmt.Sprintf("%s:%s:%s:\"%s\"", p.Datatype,
